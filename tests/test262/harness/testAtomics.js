...
// The upstream Atomics index and non-view value generators, unchanged in
// behavior. The repository formatter owns every JavaScript file here, so
// spacing differs from upstream while every generated value is identical.
// The non-view list constructs a Boolean wrapper, so a case that includes
// this file stays outside the profile until the Boolean intrinsic is
// admitted rather than running against a shortened list.
