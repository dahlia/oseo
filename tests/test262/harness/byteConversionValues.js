// The upstream conversion table, unchanged in value. The repository
// formatter owns every JavaScript file here, so comment layout and
// trailing commas differ from upstream while every listed value and
// expectation is identical.
