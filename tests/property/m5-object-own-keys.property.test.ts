    ...
    await assertAsyncProperty(
      ...
      }),
      {
        ...
        domain:
          ...
          "virtual, enumerable, replaced, deleted, and redefined String " +
          "iterators ordered against a generated later symbol; " +
        ...
        sizeLimit:
          ...
          "code points, six String iterator observations, two Boolean " +
