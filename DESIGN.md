...
coverage. See the [activity audit](docs/sanitizer-activity.md) for measurements
...
Weak edges use a collector-owned phase boundary rather than ordinary object
