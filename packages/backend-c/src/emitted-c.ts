...
export const emittedC = {
  ...
  regexpLiteral: {
    uint16ArrayDeclaration: [["static uint16_t "], ["[] = {"], ["};"]],
    uint32ArrayDeclaration: [["static uint32_t "], ["[] = {"], ["};"]],
    instructionArrayDeclaration: [
      ["static OseoRegExpInstruction "],
      ["[] = {"],
      ["};"],
    ],
    repeatArrayDeclaration: [["static OseoRegExpRepeat "], ["[] = {"], ["};"]],
    captureArrayDeclaration: [
      ["static OseoRegExpCapture "],
      ["[] = {"],
      ["};"],
    ],
    instructionValue: [
    ...
    captureValue: [["{"], ["u, "], ["u, "], ["}"]],
    unsignedValue: [[""], ["u"]],
    unsignedLongValue: [["UINT64_C("], [")"]],
    unboundedValue: [["UINT64_MAX"]],
    programDeclaration: [["static OseoRegExpProgram "], [" = {"], ["};"]],
    literalDeclaration: [["static const OseoRegExpLiteral "], [" = {"], ["};"]],
    programAddress: [["&"], [""]],
    resultAssign: [["result = oseo_regexp_literal(context, &"], [");"]],
  },
  constant: {
  ...
  iteratorIntrinsic: {
    resultAssign: [
      ["result = oseo_intrinsic(context, OSEO_INTRINSIC_ITERATOR);"],
    ],
  },
  constructReceiver: {
  ...
  agent: {
    holeStatement: [["result = oseo_agent_hole(context, "], ["u);"]],
    entryPrototype: [
      ["OseoResult oseo_agent_program_"],
      ["(OseoContext *);\n"],
    ],
    segmentUnits: [
      ["static const uint16_t oseo_agent_segment_"],
      ["_"],
      ["[] = {"],
      ["};\n"],
    ],
    segmentEntry: [["{oseo_agent_segment_"], ["_"], [", "], ["u}"]],
    segmentTable: [
      ["static const OseoAgentSegment oseo_agent_segments_"],
      ["[] = {"],
      ["};\n"],
    ],
    programEntry: [
      ["{oseo_agent_segments_"],
      [", "],
      ["u, oseo_agent_program_"],
      [', "'],
      ['", '],
      ["u}"],
    ],
    programTable: [
      ["static const OseoAgentProgram oseo_agent_programs[] = {"],
      ["};\n"],
    ],
    installLine: [
      ["    result = oseo_test262_host_install(\n        &context, "],
      [", "],
      [
        "u);\n    if (result.status != OSEO_STATUS_NORMAL) {\n    ",
    ...
    sourceRunUnits: [
      ["static const uint16_t function_source_run_"],
      ["_"],
      ["[] = {"],
      ["};"],
    ],
    sourceRunEntry: [["{function_source_run_"], ["_"], [", "], ["u}"]],
    sourceRuns: [
      ["static const OseoAgentSegment function_source_runs_"],
      ["[] = {"],
      ["};"],
    ],
    holeIndex: [[""], ["u"]],
    sourceHoles: [
      ["static const size_t function_source_holes_"],
      ["[] = {"],
      ["};"],
    ],
    setSource: [
      ["result = oseo_agent_function_set_source(context, roots["],
      ["], function_source_runs_"],
      [", "],
      ["u, function_source_holes_"],
      [");"],
    ],
    programsValue: [["oseo_agent_programs"]],
    noProgramsValue: [["NULL"]],
    generatorRegistrationLine: [
      [
