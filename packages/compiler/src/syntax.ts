 ...
 * than describing the store twice. The enumerated key is always a String,
 * and the realm's String iterator lets an array pattern consume its code
 * points through the same recursive binding machinery a for-of head uses.
 */
export type SyntaxForInTarget = SyntaxForOfTarget;
