...
#define OSEO_ARRAY_POP_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 27u)
#define OSEO_ARRAY_SHIFT_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 28u)
#define OSEO_ARRAY_UNSHIFT_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 29u)
#define OSEO_ARRAY_SPLICE_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 30u)
#define OSEO_ARRAY_FILL_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 31u)
#define OSEO_ARRAY_COPY_WITHIN_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 32u)
#define OSEO_ARRAY_REVERSE_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 33u)
#define OSEO_ARRAY_FIND_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 34u)
#define OSEO_ARRAY_FIND_INDEX_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 35u)
#define OSEO_ARRAY_FIND_LAST_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 36u)
#define OSEO_ARRAY_FIND_LAST_INDEX_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 37u)
