...
#define OSEO_ARRAY_TO_REVERSED_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 38u)
#define OSEO_ARRAY_TO_SPLICED_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 39u)
#define OSEO_ARRAY_WITH_CODE_ID \
    (OSEO_ARRAY_CODE_ID_RANGE_LAST - 40u)
...
#define OSEO_STRING_REPEAT_CODE_ID \
    (OSEO_STRING_CODE_ID_RANGE_LAST - 33u)
#define OSEO_STRING_PAD_START_CODE_ID \
    (OSEO_STRING_CODE_ID_RANGE_LAST - 34u)
#define OSEO_STRING_PAD_END_CODE_ID \
    (OSEO_STRING_CODE_ID_RANGE_LAST - 35u)
#define OSEO_STRING_IS_WELL_FORMED_CODE_ID \
    (OSEO_STRING_CODE_ID_RANGE_LAST - 36u)
#define OSEO_STRING_TO_WELL_FORMED_CODE_ID \
    (OSEO_STRING_CODE_ID_RANGE_LAST - 37u)
...
#define OSEO_SET_UNION_CODE_ID (OSEO_SET_CODE_ID_RANGE_LAST - 11u)
#define OSEO_SET_INTERSECTION_CODE_ID (OSEO_SET_CODE_ID_RANGE_LAST - 12u)
#define OSEO_SET_DIFFERENCE_CODE_ID (OSEO_SET_CODE_ID_RANGE_LAST - 13u)
#define OSEO_SET_SYMMETRIC_DIFFERENCE_CODE_ID \
    (OSEO_SET_CODE_ID_RANGE_LAST - 14u)
#define OSEO_SET_IS_SUBSET_OF_CODE_ID (OSEO_SET_CODE_ID_RANGE_LAST - 15u)
#define OSEO_SET_IS_SUPERSET_OF_CODE_ID (OSEO_SET_CODE_ID_RANGE_LAST - 16u)
#define OSEO_SET_IS_DISJOINT_FROM_CODE_ID \
    (OSEO_SET_CODE_ID_RANGE_LAST - 17u)
...
#define OSEO_TYPED_ARRAY_EVERY_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 24u)
#define OSEO_TYPED_ARRAY_FILTER_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 25u)
#define OSEO_TYPED_ARRAY_FOR_EACH_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 26u)
#define OSEO_TYPED_ARRAY_MAP_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 27u)
#define OSEO_TYPED_ARRAY_REDUCE_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 28u)
#define OSEO_TYPED_ARRAY_REDUCE_RIGHT_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 29u)
#define OSEO_TYPED_ARRAY_SOME_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 30u)
#define OSEO_TYPED_ARRAY_FIND_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 31u)
#define OSEO_TYPED_ARRAY_FIND_INDEX_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 32u)
#define OSEO_TYPED_ARRAY_FIND_LAST_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 33u)
#define OSEO_TYPED_ARRAY_FIND_LAST_INDEX_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 34u)
#define OSEO_TYPED_ARRAY_INCLUDES_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 35u)
#define OSEO_TYPED_ARRAY_INDEX_OF_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 36u)
#define OSEO_TYPED_ARRAY_JOIN_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 37u)
#define OSEO_TYPED_ARRAY_LAST_INDEX_OF_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 38u)
#define OSEO_TYPED_ARRAY_TO_LOCALE_STRING_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 39u)
#define OSEO_TYPED_ARRAY_COPY_WITHIN_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 40u)
#define OSEO_TYPED_ARRAY_FILL_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 41u)
#define OSEO_TYPED_ARRAY_REVERSE_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 42u)
#define OSEO_TYPED_ARRAY_SLICE_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 43u)
#define OSEO_TYPED_ARRAY_TO_REVERSED_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 44u)
#define OSEO_TYPED_ARRAY_WITH_CODE_ID \
    (OSEO_TYPED_ARRAY_CODE_ID_RANGE_LAST - 45u)
#define OSEO_TYPED_ARRAY_SORT_CODE_ID \
