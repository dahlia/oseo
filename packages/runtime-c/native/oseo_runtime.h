...
typedef enum {
    ...
    OSEO_INTRINSIC_ITERATOR = 57,
    OSEO_INTRINSIC_ITERATOR_FROM = 58,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_PROTOTYPE = 59,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_NEXT = 60,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_RETURN = 61,
    OSEO_INTRINSIC_ITERATOR_CONSTRUCTOR_GETTER = 62,
    OSEO_INTRINSIC_ITERATOR_CONSTRUCTOR_SETTER = 63,
    OSEO_INTRINSIC_ITERATOR_TAG_GETTER = 64,
    OSEO_INTRINSIC_ITERATOR_TAG_SETTER = 65,
    OSEO_INTRINSIC_NUMBER_PROTOTYPE = 66,
    OSEO_INTRINSIC_NUMBER = 67,
    OSEO_INTRINSIC_NUMBER_IS_FINITE = 68,
    OSEO_INTRINSIC_NUMBER_IS_INTEGER = 69,
    OSEO_INTRINSIC_NUMBER_IS_NAN = 70,
    OSEO_INTRINSIC_NUMBER_IS_SAFE_INTEGER = 71,
    OSEO_INTRINSIC_NUMBER_PARSE_FLOAT = 72,
    OSEO_INTRINSIC_NUMBER_PARSE_INT = 73,
    OSEO_INTRINSIC_COUNT = 74,
} OseoIntrinsic;
