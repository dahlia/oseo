...
typedef enum {
    ...
    OSEO_INTRINSIC_OBJECT_GET_PROTOTYPE_OF = 51,
    OSEO_INTRINSIC_OBJECT_IS = 52,
    OSEO_INTRINSIC_OBJECT_SET_PROTOTYPE_OF = 53,
    OSEO_INTRINSIC_BOOLEAN_PROTOTYPE = 54,
    OSEO_INTRINSIC_STRING_PROTOTYPE = 55,
    OSEO_INTRINSIC_BIGINT_PROTOTYPE = 56,
    OSEO_INTRINSIC_FUNCTION = 57,
    OSEO_INTRINSIC_FUNCTION_APPLY = 58,
    OSEO_INTRINSIC_FUNCTION_BIND = 59,
    OSEO_INTRINSIC_FUNCTION_CALL = 60,
    OSEO_INTRINSIC_FUNCTION_TO_STRING = 61,
    OSEO_INTRINSIC_FUNCTION_HAS_INSTANCE = 62,
    OSEO_INTRINSIC_ITERATOR = 63,
    OSEO_INTRINSIC_ITERATOR_FROM = 64,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_PROTOTYPE = 65,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_NEXT = 66,
    OSEO_INTRINSIC_WRAP_FOR_VALID_ITERATOR_RETURN = 67,
    OSEO_INTRINSIC_ITERATOR_CONSTRUCTOR_GETTER = 68,
    OSEO_INTRINSIC_ITERATOR_CONSTRUCTOR_SETTER = 69,
    OSEO_INTRINSIC_ITERATOR_TAG_GETTER = 70,
    OSEO_INTRINSIC_ITERATOR_TAG_SETTER = 71,
    OSEO_INTRINSIC_NUMBER_PROTOTYPE = 72,
    OSEO_INTRINSIC_NUMBER = 73,
    OSEO_INTRINSIC_NUMBER_IS_FINITE = 74,
    OSEO_INTRINSIC_NUMBER_IS_INTEGER = 75,
    OSEO_INTRINSIC_NUMBER_IS_NAN = 76,
    ...
    OSEO_INTRINSIC_ARRAY_BUFFER_PROTOTYPE = 90,
    OSEO_INTRINSIC_ARRAY_BUFFER = 91,
    OSEO_INTRINSIC_ARRAY_BUFFER_IS_VIEW = 92,
    OSEO_INTRINSIC_ARRAY_BUFFER_BYTE_LENGTH = 93,
    OSEO_INTRINSIC_ARRAY_BUFFER_DETACHED = 94,
    OSEO_INTRINSIC_ARRAY_BUFFER_MAX_BYTE_LENGTH = 95,
    OSEO_INTRINSIC_ARRAY_BUFFER_RESIZABLE = 96,
    OSEO_INTRINSIC_ARRAY_BUFFER_RESIZE = 97,
    OSEO_INTRINSIC_ARRAY_BUFFER_SLICE = 98,
    OSEO_INTRINSIC_ARRAY_BUFFER_TRANSFER = 99,
    OSEO_INTRINSIC_ARRAY_BUFFER_TRANSFER_TO_FIXED_LENGTH = 100,
    OSEO_INTRINSIC_ARRAY_BUFFER_SPECIES = 101,
    OSEO_INTRINSIC_ARRAY = 102,
    OSEO_INTRINSIC_ARRAY_FROM = 103,
    OSEO_INTRINSIC_ARRAY_IS_ARRAY = 104,
    OSEO_INTRINSIC_ARRAY_OF = 105,
    OSEO_INTRINSIC_ARRAY_SPECIES_GETTER = 106,
    OSEO_INTRINSIC_STRING = 107,
    OSEO_INTRINSIC_STRING_FROM_CHAR_CODE = 108,
    OSEO_INTRINSIC_STRING_FROM_CODE_POINT = 109,
    OSEO_INTRINSIC_STRING_RAW = 110,
    OSEO_INTRINSIC_REGEXP_STRING_ITERATOR_PROTOTYPE = 111,
    OSEO_INTRINSIC_REGEXP_STRING_ITERATOR_NEXT = 112,
    OSEO_INTRINSIC_MAP_ITERATOR_PROTOTYPE = 113,
    OSEO_INTRINSIC_MAP_ITERATOR_NEXT = 114,
    OSEO_INTRINSIC_MAP_PROTOTYPE = 115,
    OSEO_INTRINSIC_MAP_GET = 116,
    OSEO_INTRINSIC_MAP_SET = 117,
    OSEO_INTRINSIC_MAP_HAS = 118,
    OSEO_INTRINSIC_MAP_DELETE = 119,
    OSEO_INTRINSIC_MAP_CLEAR = 120,
    OSEO_INTRINSIC_MAP_FOR_EACH = 121,
    OSEO_INTRINSIC_MAP_ENTRIES = 122,
    OSEO_INTRINSIC_MAP_KEYS = 123,
    OSEO_INTRINSIC_MAP_VALUES = 124,
    OSEO_INTRINSIC_MAP_SIZE_GETTER = 125,
    OSEO_INTRINSIC_MAP = 126,
    OSEO_INTRINSIC_MAP_GROUP_BY = 127,
    OSEO_INTRINSIC_MAP_SPECIES = 128,
    OSEO_INTRINSIC_BIGINT = 129,
    OSEO_INTRINSIC_BIGINT_AS_INT_N = 130,
    OSEO_INTRINSIC_BIGINT_AS_UINT_N = 131,
    OSEO_INTRINSIC_BIGINT_TO_STRING = 132,
    OSEO_INTRINSIC_BIGINT_TO_LOCALE_STRING = 133,
    OSEO_INTRINSIC_BIGINT_VALUE_OF = 134,
    OSEO_INTRINSIC_DATA_VIEW_PROTOTYPE = 135,
    OSEO_INTRINSIC_DATA_VIEW = 136,
    OSEO_INTRINSIC_DATA_VIEW_BUFFER = 137,
    OSEO_INTRINSIC_DATA_VIEW_BYTE_LENGTH = 138,
    OSEO_INTRINSIC_DATA_VIEW_BYTE_OFFSET = 139,
    OSEO_INTRINSIC_DATA_VIEW_GET_INT8 = 140,
    OSEO_INTRINSIC_DATA_VIEW_GET_UINT8 = 141,
    OSEO_INTRINSIC_DATA_VIEW_GET_INT16 = 142,
    OSEO_INTRINSIC_DATA_VIEW_GET_UINT16 = 143,
    OSEO_INTRINSIC_DATA_VIEW_GET_INT32 = 144,
    OSEO_INTRINSIC_DATA_VIEW_GET_UINT32 = 145,
    OSEO_INTRINSIC_DATA_VIEW_GET_FLOAT16 = 146,
    OSEO_INTRINSIC_DATA_VIEW_GET_FLOAT32 = 147,
    OSEO_INTRINSIC_DATA_VIEW_GET_FLOAT64 = 148,
    OSEO_INTRINSIC_DATA_VIEW_GET_BIG_INT64 = 149,
    OSEO_INTRINSIC_DATA_VIEW_GET_BIG_UINT64 = 150,
    OSEO_INTRINSIC_DATA_VIEW_SET_INT8 = 151,
    OSEO_INTRINSIC_DATA_VIEW_SET_UINT8 = 152,
    OSEO_INTRINSIC_DATA_VIEW_SET_INT16 = 153,
    OSEO_INTRINSIC_DATA_VIEW_SET_UINT16 = 154,
    OSEO_INTRINSIC_DATA_VIEW_SET_INT32 = 155,
    OSEO_INTRINSIC_DATA_VIEW_SET_UINT32 = 156,
    OSEO_INTRINSIC_DATA_VIEW_SET_FLOAT16 = 157,
    OSEO_INTRINSIC_DATA_VIEW_SET_FLOAT32 = 158,
    OSEO_INTRINSIC_DATA_VIEW_SET_FLOAT64 = 159,
    OSEO_INTRINSIC_DATA_VIEW_SET_BIG_INT64 = 160,
    OSEO_INTRINSIC_DATA_VIEW_SET_BIG_UINT64 = 161,
    OSEO_INTRINSIC_REGEXP_PROTOTYPE = 162,
    OSEO_INTRINSIC_REGEXP = 163,
    OSEO_INTRINSIC_REGEXP_SPECIES = 164,
    OSEO_INTRINSIC_MATH = 165,
    OSEO_INTRINSIC_GENERATOR_FUNCTION_PROTOTYPE = 166,
    OSEO_INTRINSIC_GENERATOR_FUNCTION = 167,
    OSEO_INTRINSIC_ASYNC_FUNCTION_PROTOTYPE = 168,
    OSEO_INTRINSIC_ASYNC_FUNCTION = 169,
    OSEO_INTRINSIC_ITERATOR_MAP = 170,
    OSEO_INTRINSIC_ITERATOR_FILTER = 171,
    OSEO_INTRINSIC_ITERATOR_TAKE = 172,
    OSEO_INTRINSIC_ITERATOR_DROP = 173,
    OSEO_INTRINSIC_ITERATOR_FLAT_MAP = 174,
    OSEO_INTRINSIC_ITERATOR_HELPER_PROTOTYPE = 175,
    OSEO_INTRINSIC_ITERATOR_HELPER_NEXT = 176,
    OSEO_INTRINSIC_ITERATOR_HELPER_RETURN = 177,
    OSEO_INTRINSIC_DECODE_URI = 178,
    ...
    OSEO_INTRINSIC_ARRAY_KEYS = 185,
    OSEO_INTRINSIC_ARRAY_ENTRIES = 186,
    OSEO_INTRINSIC_PROXY = 187,
    OSEO_INTRINSIC_ITERATOR_REDUCE = 188,
    OSEO_INTRINSIC_ITERATOR_TO_ARRAY = 189,
    OSEO_INTRINSIC_ITERATOR_FOR_EACH = 190,
    OSEO_INTRINSIC_ITERATOR_SOME = 191,
    OSEO_INTRINSIC_ITERATOR_EVERY = 192,
    OSEO_INTRINSIC_ITERATOR_FIND = 193,
    OSEO_INTRINSIC_DATE_PROTOTYPE = 194,
    OSEO_INTRINSIC_DATE = 195,
    OSEO_INTRINSIC_STRING_ITERATOR_PROTOTYPE = 196,
    OSEO_INTRINSIC_STRING_ITERATOR_NEXT = 197,
    OSEO_INTRINSIC_STRING_PROTOTYPE_ITERATOR = 198,
    OSEO_INTRINSIC_JSON = 199,
    OSEO_INTRINSIC_JSON_PARSE = 200,
    OSEO_INTRINSIC_SET_PROTOTYPE = 201,
    OSEO_INTRINSIC_SET = 202,
    OSEO_INTRINSIC_SET_ADD = 203,
    OSEO_INTRINSIC_SET_CLEAR = 204,
    OSEO_INTRINSIC_SET_DELETE = 205,
    OSEO_INTRINSIC_SET_ENTRIES = 206,
    OSEO_INTRINSIC_SET_FOR_EACH = 207,
    OSEO_INTRINSIC_SET_HAS = 208,
    OSEO_INTRINSIC_SET_SIZE = 209,
    OSEO_INTRINSIC_SET_VALUES = 210,
    OSEO_INTRINSIC_SET_ITERATOR_PROTOTYPE = 211,
    OSEO_INTRINSIC_SET_ITERATOR_NEXT = 212,
    OSEO_INTRINSIC_SET_SPECIES = 213,
    OSEO_INTRINSIC_TYPED_ARRAY_PROTOTYPE = 214,
    OSEO_INTRINSIC_TYPED_ARRAY = 215,
    OSEO_INTRINSIC_INT8_ARRAY_PROTOTYPE = 216,
    OSEO_INTRINSIC_INT8_ARRAY = 217,
    OSEO_INTRINSIC_UINT8_ARRAY_PROTOTYPE = 218,
    OSEO_INTRINSIC_UINT8_ARRAY = 219,
    OSEO_INTRINSIC_UINT8_CLAMPED_ARRAY_PROTOTYPE = 220,
    OSEO_INTRINSIC_UINT8_CLAMPED_ARRAY = 221,
    OSEO_INTRINSIC_INT16_ARRAY_PROTOTYPE = 222,
    OSEO_INTRINSIC_INT16_ARRAY = 223,
    OSEO_INTRINSIC_UINT16_ARRAY_PROTOTYPE = 224,
    OSEO_INTRINSIC_UINT16_ARRAY = 225,
    OSEO_INTRINSIC_INT32_ARRAY_PROTOTYPE = 226,
    OSEO_INTRINSIC_INT32_ARRAY = 227,
    OSEO_INTRINSIC_UINT32_ARRAY_PROTOTYPE = 228,
    OSEO_INTRINSIC_UINT32_ARRAY = 229,
    OSEO_INTRINSIC_FLOAT32_ARRAY_PROTOTYPE = 230,
    OSEO_INTRINSIC_FLOAT32_ARRAY = 231,
    OSEO_INTRINSIC_FLOAT64_ARRAY_PROTOTYPE = 232,
    OSEO_INTRINSIC_FLOAT64_ARRAY = 233,
    OSEO_INTRINSIC_BIGINT64_ARRAY_PROTOTYPE = 234,
    OSEO_INTRINSIC_BIGINT64_ARRAY = 235,
    OSEO_INTRINSIC_BIGUINT64_ARRAY_PROTOTYPE = 236,
    OSEO_INTRINSIC_BIGUINT64_ARRAY = 237,
    OSEO_INTRINSIC_COUNT = 238,
} OseoIntrinsic;
