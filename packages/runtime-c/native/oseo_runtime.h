...
typedef enum {
    ...
    OSEO_INTRINSIC_STRING = 102,
    OSEO_INTRINSIC_STRING_FROM_CHAR_CODE = 103,
    OSEO_INTRINSIC_STRING_FROM_CODE_POINT = 104,
    OSEO_INTRINSIC_STRING_RAW = 105,
    OSEO_INTRINSIC_COUNT = 106,
} OseoIntrinsic;
